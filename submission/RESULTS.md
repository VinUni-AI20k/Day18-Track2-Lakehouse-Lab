...
Environment: Python 3.13.5, `deltalake` 1.6.2, `pyiceberg` 0.11.1, DuckDB 1.5.5. Spark and Docker were not used.

## Verification

- `make smoke`: 9/9 checks passed.
- `make test`: 24/24 tests passed.
- `make run-all`: 8/8 notebooks passed in 33.5 seconds.
...
| NB2 | 14.7× wall-clock speedup; 55× file-pruning ratio |
