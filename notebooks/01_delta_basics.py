...
# %% [markdown]
# ## ✅ Deliverable check
# - [ ] MinIO console shows `_delta_log/` with JSON files
# - [ ] Schema enforcement blocked the `age=str` bad write
# - [ ] `mergeSchema=true` added the `tier` column (NULL for existing rows)
